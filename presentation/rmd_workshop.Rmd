...
[Part 7. Cache Functionality](#part8)
   - don't recompute everything with every compilation

[Part 8. Reusing Code](#part8)
   - e.g., building up figures, child documents
   
[Part 9. Fancy Templates](#part8)
   - e.g., producing publication ready papers

[Part 10. Addressing Functionality Gaps](#part7)
   - e.g., adjusting line spacing

[Part 11. Using Version Control](#part8)
   - e.g., integrating Git and GitHub

[Part 12. Collaborating with Others](#part9)
...
xxx this should be moved to the other markdown stuff, just after links.
...
---
## Figures &mdash; `ggplot2` `r cp("ggplot2")` &mdash; Overview

- A very, very powerful package for visualising data 
...
* Actually, the whole thing should be moved to the markdown part, as should the static figures.
* If we do that, however, the logic for cross references has to get set straight.
...
---
## Tables &mdash; `stargazer` `r cp("stargazer")` &mdash; Overview
