...
- `tidyverse` `r cp("tidyverse")`, for data manipulation pipes
    - the modern paradigm for wrangling your data.

--

- `stargazer`, `r cp("stargazer")` for tables
    - alternatives: e.g., `knitr` `r cp("knitr")`, `kableExtra` `r cp("kableExtra")`
    
--

  
- `ggplot2` `r cp("ggplot2")`, for figures
    - alternatives: e.g., `base` `r cp("base")`, `plotly` `r cp("plotly")`
...
* Click the ▼ to the right of the `Knit` button
  - choose "knit to pdf" from the dropdown.
  - you see another document appear
  - don't be surprised if it's a PDF.
