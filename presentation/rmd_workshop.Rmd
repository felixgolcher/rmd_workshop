...
* In any case you have to hope that the script did not change since then.
...
**What now? Which is the right version?**
...
- Efficient
   ...
   - All (?) work steps in one work environment (Rstudio)
...
# It's even scriptable &mdash; Use case
